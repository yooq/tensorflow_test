...
# print('text_sequences',text_sequences.shape)  #text_sequences (11726, 961)
# print('label_sequences',label_sequences.shape) #text_sequences (11726, 961)


train_dataset = tf.data.Dataset.from_tensor_slices((text_sequences, label_sequences))
# bacth_size =32,每一批32个句子
